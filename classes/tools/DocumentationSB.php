...
class DocumentationSB
{
    public static function assignDocumentation()
    {
        ...
        HelperModuleSB::addCSS('documentation.css');
        $documentation_folder = _PS_MODULE_DIR_.ToolsModuleSB::getModNameForPath(__FILE__)
            .'/views/templates/admin/documentation';
        $documentation_pages = ToolsModuleSB::globRecursive($documentation_folder.'/**.tpl');
